<?php
    ...
    $figuresInfo = $db->queryAll("SELECT `figure`.`id_figure` AS `id_figure`, `figure`.`name` AS `name`, `figure`.`image` AS `image` FROM `figure`, `figure_user` WHERE `figure_user`.`id_user` = $idUser AND `figure_user`.`id_figure` = `figure`.`id_figure`");
